...
${isWin ? `@${(isSurrender ? room.game.currentTurn : room.game.winner).split('@')[0]} 𝐆𝐚𝐧𝐚𝐬𝐭𝐞 🥳, 𝐭𝐞 𝐥𝐥𝐞𝐯𝐚𝐬 +499 𝐞𝐱𝐩` : isTie ? '𝐄𝐥 𝐣𝐮𝐞𝐠𝐨 𝐭𝐞𝐫𝐦𝐢𝐧𝐨 𝐞𝐧 𝐞𝐦𝐩𝐚𝐭𝐞 😐' : `𝐓𝐮𝐫𝐧𝐨 𝐝𝐞 @${room.game.currentTurn.split('@')[0]}`}
`.trim()
