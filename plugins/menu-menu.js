...
║➣° ඬ ⃟ 💟 _Que es un Bot_ (𝑢𝑠𝑜 𝑠𝑖𝑛 𝑝𝑟𝑒𝑓𝑖𝑗𝑜)

╰──────────────╯
╭──────────────╮
║➣ *𝕌ℕ𝔼 𝕌ℕ 𝔹𝕆𝕋 𝔸 𝕋𝕌 𝔾ℝ𝕌ℙ𝕆/>*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
║➣ 𝑨𝒈𝒓𝒆𝒈𝒂 𝒂𝒍 𝑩𝒐𝒕 𝒂 𝒕𝒖 𝒈𝒓𝒖𝒑𝒐 𝒚 𝒅𝒂𝒍𝒆 𝒂𝒅𝒎𝒊𝒏
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
...
║➣ 𝑼𝒔𝒂 𝒆𝒔𝒕𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒔𝒊 𝒉𝒂𝒚 𝒂𝒍𝒈𝒖𝒏 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒄𝒐𝒏 𝒆𝒓𝒓𝒐𝒓 𝒑𝒂𝒓𝒂 𝒒𝒖𝒆 𝒎𝒊 𝒐𝒘𝒏𝒆𝒓 𝒍𝒐 𝒂𝒓𝒓𝒆𝒈𝒍𝒆
╰──────────────╯
╭──────────────╮
║➣ *𝔻𝔼𝕊ℂ𝔸ℝ𝔾𝔸𝕊/>*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
...
║➣ *𝕄𝔼ℕ𝕌 ℕ𝕊𝔽𝕎🔞/>*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
║➣ 𝑬𝒔𝒕𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒅𝒆𝒃𝒆 𝒔𝒆𝒓 𝒂𝒄𝒕𝒊𝒗𝒂𝒅𝒐 𝒑𝒐𝒓 𝒂𝒅𝒎𝒊𝒏 𝒖𝒔𝒂𝒏𝒅𝒐 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐
║➣ */enable modohorny*
║➣ 𝑳𝒖𝒆𝒈𝒐 𝒑𝒊𝒅𝒆 𝒆𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐
║➣ */menunsfw*
╰──────────────╯
╭──────────────╮
║➣ *𝔼𝔽𝔼ℂ𝕋𝕆𝕊 𝔻𝔼 𝔸𝕌𝔻𝕀𝕆𝕊/>*
...
╭──────────────╮
║➣ *𝔸𝕌𝔻𝕀𝕆𝕊/>* 
║➣ 𝑬𝒔𝒄𝒓𝒊𝒃𝒆 𝒍𝒂𝒔 𝒔𝒊𝒈𝒖𝒊𝒆𝒏𝒕𝒆𝒔 𝒑𝒂𝒍𝒂𝒃𝒓𝒂𝒔 𝒐 𝒇𝒓𝒂𝒔𝒆𝒔 𝒔𝒊𝒏 𝒆𝒍 𝒑𝒓𝒆𝒇𝒊𝒋𝒐 (#, /, *, .)
_(𝑢𝑠𝑜 𝑠𝑖𝑛 𝑝𝑟𝑒𝑓𝑖𝑗𝑜)_
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡
