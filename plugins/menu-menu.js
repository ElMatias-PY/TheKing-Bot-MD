...
° ඬ⃟☑️ _${usedPrefix}enabld *antitraba*_
...
`.trim()
conn.sendHydrated2(m.chat, str, wm, pp, 'https://instagram.com/matiass.zzz', '𝙸𝙽𝚂𝚃𝙰𝙶𝚁𝙰𝙼', '+595 985 958 156', '𝙽° 𝙳𝙴 𝙼𝙸 𝙲𝚁𝙴𝙰𝙳𝙾𝚁', [
['𝙱𝙾𝚃🤖', 'bot'],
['𝙲𝚁𝙴𝙰𝙳𝙾𝚁🥵', '/owner'],
['𝙿𝙸𝙽𝙶🚀', '/ping'],
], m,)
