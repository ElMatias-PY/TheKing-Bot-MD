...
let fgif = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`️u`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `𝐓𝐡𝐞 𝐊𝐢𝐧𝐠 - 𝐁𝐨𝐭`, 'jpegThumbnail': false }}}
let apikey = keysxxx
...
conn.sendButton(m.chat, `_${command}_`.trim(), `*◈•@${who.split("@s.whatsapp.net")[0]}*`, haha.data, [['🔄 𝐒𝐈𝐆𝐔𝐈𝐄𝐍𝐓𝐄 🔄', `/${command}`]], fgif, { mentions: [who] })}
if (command == 'pubg') {
