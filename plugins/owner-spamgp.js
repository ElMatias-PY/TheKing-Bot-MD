...
let handler = async (m, { conn, text, isOwner, usedPrefix, command }) => {
  ...
  await conn.sendMessage(res, { text: 'https://chat.whatsapp.com/DEt0xUbC2Fd2uHxKWLdQpn', mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fakegif })
await conn.sendMessage(res, { text: 'https://chat.whatsapp.com/DEt0xUbC2Fd2uHxKWLdQpn', mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fakegif })
await conn.sendMessage(res, { text: 'https://chat.whatsapp.com/DEt0xUbC2Fd2uHxKWLdQpn', mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fakegif })
await conn.sendMessage(res, { text: 'https://chat.whatsapp.com/DEt0xUbC2Fd2uHxKWLdQpn', mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fakegif })
await conn.sendMessage(res, { text: 'https://chat.whatsapp.com/DEt0xUbC2Fd2uHxKWLdQpn', mentions: (await conn.groupMetadata(`${res}`)).participants.map(v => v.id) }, { quoted: fakegif })
