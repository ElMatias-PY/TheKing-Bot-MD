...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ 𝑩𝒊𝒆𝒏𝒗𝒆𝒏𝒊𝒅𝒐/𝒂* \n*║*\n*╟❧ 𝑫𝒆𝒔𝒄𝒓𝒊𝒑𝒄𝒊𝒐𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐:*\n*╟❧* @desc\n*║* \n*╟❧/𝑷𝒖𝒆𝒅𝒆𝒔 𝒔𝒐𝒍𝒊𝒄𝒊𝒕𝒂𝒓 𝒎𝒊 𝒍𝒊𝒔𝒕𝒂𝒔 𝒅𝒆 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒄𝒐𝒏*\n*╟❧ #menu*\n*╟❧𝑫𝒊𝒔𝒇𝒓𝒖𝒕𝒂 𝒕𝒖 𝒆𝒔𝒕𝒂𝒅𝒊𝒂!!!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n╟❧ 𝑺𝒆 𝒇𝒖𝒆 𝒖𝒏𝒂 𝒑𝒖𝒕@ @user \n╟❧ 𝑶𝒋𝒂𝒍𝒂 𝒏𝒐 𝒗𝒖𝒆𝒍𝒗𝒂 𝒚 𝒒𝒖𝒆 𝒔𝒆𝒂 𝒈𝒂𝒚🤣\n*╚══════════════*'
conn.spromote = '𝑭𝒆𝒍𝒊𝒄𝒊𝒕𝒂𝒄𝒊𝒐𝒏𝒆𝒔🥳 *@user*, 𝒂𝒉𝒐𝒓𝒂 𝒆𝒓𝒆𝒔 𝒂𝒅𝒎𝒊𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐!!!'
conn.sdemote = '𝑳𝒐 𝒔𝒊𝒆𝒏𝒕𝒐 😔 *@user*, 𝒚𝒂 𝒏𝒐 𝒆𝒓𝒆𝒔 𝒂𝒅𝒎𝒊𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐!!!'
conn.sDesc = '𝑺𝒆 𝒉𝒂 𝒎𝒐𝒅𝒊𝒇𝒊𝒄𝒂𝒅𝒐 𝒍𝒂 𝒅𝒆𝒔𝒄𝒓𝒊𝒑𝒄𝒊𝒐𝒏 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐\n\n𝑵𝒖𝒆𝒗𝒂 𝒅𝒆𝒔𝒄𝒓𝒊𝒑𝒄𝒊𝒐𝒏: @desc'
conn.sSubject = '𝑺𝒆 𝒉𝒂 𝒎𝒐𝒅𝒊𝒇𝒊𝒄𝒂𝒅𝒐 𝒆𝒍 𝒏𝒐𝒎𝒃𝒓𝒆 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐\n𝑵𝒖𝒆𝒗𝒐 𝒏𝒐𝒎𝒃𝒓𝒆: @subject'
conn.sIcon = '𝑺𝒆 𝒉𝒂 𝒄𝒂𝒎𝒃𝒊𝒂𝒅𝒐 𝒆𝒍 𝒊𝒄𝒐𝒏𝒐 𝒅𝒆𝒍 𝒈𝒓𝒖𝒑𝒐!!!'
